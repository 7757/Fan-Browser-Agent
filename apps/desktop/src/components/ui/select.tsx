...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
  return (
    <SelectPrimitive.Item
      className={cn(
        'relative flex w-full cursor-pointer items-center gap-2 rounded-[0.375rem] py-1.5 pr-8 pl-2 text-[0.8125rem] outline-none select-none focus:bg-[color-mix(in_srgb,var(--dt-primary)_8%,transparent)] focus:text-primary data-disabled:pointer-events-none data-disabled:cursor-default data-disabled:opacity-50',
        'liquid-select-item',
        className
      )}
