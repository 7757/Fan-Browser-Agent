...
const REGISTRY_STORAGE_KEY = 'fan.desktop.sessionPreviews.v1'
...
function filePreviewTabId(target: PreviewTarget): `file:${string}` {
...
function dismissSessionPreview(sessionId: string | null | undefined, url?: string) {
  const id = sessionId?.trim()
