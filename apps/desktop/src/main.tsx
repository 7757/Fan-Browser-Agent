...
import { DevMockPreview, installDevMock } from './lib/dev-mock'
import { installDocumentVisibilityPolicy } from './lib/document-visibility-policy'
import { queryClient } from './lib/query-client'
import { ThemeProvider } from './themes/context'

installClipboardShim()
installDevMock()
installDocumentVisibilityPolicy()
