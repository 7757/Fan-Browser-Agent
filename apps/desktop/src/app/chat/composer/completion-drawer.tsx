...
export const COMPLETION_DRAWER_CLASS = [
  ...
  'composer-glass-completion',
  'p-1 text-xs text-popover-foreground'
].join(' ')
...
export const COMPLETION_DRAWER_ROW_CLASS = [
  'composer-glass-completion-row relative flex cursor-default select-none items-center gap-2 rounded-md px-2 py-1',
