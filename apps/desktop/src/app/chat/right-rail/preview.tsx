...
export const PREVIEW_RAIL_MIN_WIDTH_PX = 18 * 16
export const PREVIEW_RAIL_MIN_WIDTH = `${PREVIEW_RAIL_MIN_WIDTH_PX / 16}rem`
...
export const PREVIEW_RAIL_PANE_WIDTH = `min(${INTRINSIC}, max(0rem, calc(100vw - var(--pane-file-browser-width, 0rem) - var(--chat-min-width))))`
