"""Shared curses-based UI components for Fan CLI.

Used by `fan tools` and `fan skills` for interactive checklists.
...
def _token_score(orig: str, lower: str, token: str) -> float | None:
    ...
    Shared fuzzy scoring for terminal pickers so model ids rank consistently:
