...
These bridge terminal_tool's interactive prompts (sudo and approval)
into prompt_toolkit's event loop. Each function takes the FanSession instance
...
from fan_cli.banner import cprint, _DIM, _RST
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.fan/.env and never exposed to the model.
    """
