...
7. Unicode normalized - Normalize typographic punctuation before matching
...
def _map_normalized_positions(original: str, normalized: str,
    ...
    for norm_start, norm_end in normalized_matches:
        ...
        # Include normalized trailing whitespace only when the requested
        # match itself ended in whitespace.  Otherwise the first source space
        # is a boundary after the match and consuming it joins replacements to
        # the following word.
