"""Shared debug session infrastructure for Fan tools.

Replaces the identical DEBUG_MODE / _log_debug_call / _save_debug_log /
get_debug_session_info boilerplate previously duplicated across vision_tools,
and mixture_of_agents_tool.
...
Usage in a tool module:
    ...
    _debug.log_call("vision_analyze", {"images": 1})
...
class DebugSession:
    ...
    def __init__(self, tool_name: str, *, env_var: str) -> None:
        ...
        self.log_dir = get_fan_home() / "logs"
