...
version: 1.0.0
author: Fan Agent (adapted from gsd-build/get-shit-done)
license: MIT
...
Use Fan tools for the research step:

- `terminal("pip show websockets | grep Version")` — check what's installed in the project's venv
- `read_file("README.md")` / `search_files("websocket")` — inspect local docs and examples
- Browser automation tools — inspect external docs when research must happen in a browser
...
Adapted from the GSD (Get Shit Done) project's `/gsd-spike` workflow — MIT © 2025 Lex Christopherson ([gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done)). The full GSD system offers persistent spike state, MANIFEST tracking, and integration with a broader spec-driven development pipeline; install with `npx get-shit-done-cc --fan --global`.
