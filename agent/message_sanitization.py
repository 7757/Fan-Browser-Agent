...
_INTERRUPTED_TRANSCRIPT_MARKER = "_[interrupted]_"
...
def close_interrupted_tool_sequence(messages: list, final_response: Any = None) -> bool:
    """Close a transcript that was interrupted immediately after a tool result."""
    if not messages:
        return False
    last = messages[-1]
    ...
    if not text or text == "Operation interrupted.":
        text = _INTERRUPTED_TRANSCRIPT_MARKER
    messages.append(
        {
            "role": "assistant",
            "content": text,
